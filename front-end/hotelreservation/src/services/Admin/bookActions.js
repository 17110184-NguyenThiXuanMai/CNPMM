...
export const saveBook = book => {
    return dispatch => {
        ...
        axios.post("http://localhost:8080/api/test/books", book)
            .then(response => {
...
export const fetchBook = bookId => {
    return dispatch => {
        ...
        axios.get("http://localhost:8080/api/test/books/"+bookId)
            .then(response => {
                dispatch(bookSuccess(response.data));
            })
            .catch(error => {
...
export const updateBook = book => {
    return dispatch => {
        ...
        axios.put("http://localhost:8080/api/test/books", book)
            .then(response => {
                dispatch(bookSuccess(response.data));
            })
            .catch(error => {
...
export const deleteBook = bookId => {
    return dispatch => {
        ...
        axios.delete("http://localhost:8080/api/test/books/"+bookId)
            .then(response => {
                dispatch(bookSuccess(response.data));
            })
            .catch(error => {
