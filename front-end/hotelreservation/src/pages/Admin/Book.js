    ...
    render() {
        ...
        return (
            <div className="container">
                ...
                <Card className={"card"}>
                    <Card.Header>
                        {this.state.id ? <BsPlusSquareFill /> : <BsPlusSquareFill /> } {this.state.id ? " Update Book" :  " Add New Book"}
                    </Card.Header>
                    <Form onReset={this.resetBook} onSubmit={this.state.id ? this.updateBook : this.submitBook} id="bookFormId">
                        ...
                        <Card.Footer style={{"textAlign":"right"}}>
                            <Row>
                                ...
                                <Button size="sm" variant="info" type="button" onClick={this.bookList.bind()}> <BsListUl /> Book List
                                </Button>       
                            </Row>             
                        </Card.Footer>
                    </Form>
